...
async def notforu(_, m: Message):
    k = await _.send_cached_media(chat_id=m.chat.id, file_id="CAACAgQAAxkBAAN0YjSunhMPiI3dFc8v3ITt3_JrtfYAApkKAAJHaahRSphn1dm8fk8jBA", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('👨🏻‍🔧بیا اینجا', url='https://t.me/DIGRM')]]))
    await delete_messages([m, k])
