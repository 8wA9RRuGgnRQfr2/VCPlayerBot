...
async def notforu(_, m: Message):
    k = await _.send_cached_media(chat_id=m.chat.id, file_id="CAACAgIAAxkBAANmYjOGSHjWfMU6N_XjhKPGTWCsyrUAAvYXAAIHo6FJpE_AM_jxlf8jBA", caption="You Are Not Authorized", reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('👨🏻‍🔧بیا اینجا', url='https://t.me/DIGRM')]]))
    await delete_messages([m, k])
